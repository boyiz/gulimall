...
import com.boyiz.gulimall.cart.vo.SkuInfoVo;
...
import static com.boyiz.common.constant.CartConstant.CART_PREFIX;
...
public class CartServiceImpl implements CartService {
    ...
    public CartItemVo addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        if (StringUtils.isEmpty(productRedisValue)) {
            ...
            //开启第二个异步任务, 远程查询skuAttrValues组合信息
    ...
    @Override
    public List<CartItemVo> getUserCartItems(Long id) throws CartExceptionHandler {
