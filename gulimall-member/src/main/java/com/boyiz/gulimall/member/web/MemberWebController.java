package com.boyiz.gulimall.member.web;

import com.alibaba.fastjson.JSON;
import com.boyiz.common.utils.R;
import com.boyiz.gulimall.member.feign.OrderFeignService;
...
public class MemberWebController {
    ...
    public R memberOrderPage(@RequestParam(value = "pageNum",required = false,defaultValue = "0") Integer pageNum,
