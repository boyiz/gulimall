...
import com.boyiz.common.to.mq.StockDetailTo;
...
import com.boyiz.gulimall.ware.exception.NoStockException;
import com.boyiz.gulimall.ware.feign.OrderFeignService;
import com.boyiz.gulimall.ware.feign.ProductFeignService;
import com.boyiz.gulimall.ware.service.WareOrderTaskDetailService;
import com.boyiz.gulimall.ware.service.WareOrderTaskService;
import com.boyiz.gulimall.ware.vo.OrderItemVo;
import com.boyiz.gulimall.ware.vo.OrderVo;
...
import com.boyiz.gulimall.ware.dao.WareSkuDao;
import com.boyiz.gulimall.ware.entity.WareSkuEntity;
import com.boyiz.gulimall.ware.service.WareSkuService;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
     ...
     * @param vo
     * @return 解锁库存的场景
     * 1、下单成功，订单过期没有支付被系统取消，被用户取消
     * 2、下订单，锁库存成功，但其他业务失败导致订单回滚。
     */
    ...
    /**
     * 1、库存自动解锁
     * 下订单成功，锁库存成功，后面业务导致失败，订单回滚，之前锁定的库存自动解锁
     * 2、订单失败
     * 锁库存失败
     * <p>
     * 库存解锁失败，要告知服务器解锁失败。（手动ACK）
     **/
